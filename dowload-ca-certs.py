...
#if which('ar') is None and not os.path.isfile("C:/Users/etanc/AppData/Local/Arduino15/packages/esp8266/tools/xtensa-lx106-elf-gcc/3.0.4-gcc10.3-1757bed/xtensa-lx106-elf/bin/ar") and not os.path.isfile('./ar.exe'):
...
for i in range(0, len(pems)):
    ...
    ssl = Popen(["C:/Program Files/Git/usr/bin/openssl.exe",'x509','-inform','PEM','-outform','DER','-out', certName], shell = False, stdin = PIPE)
    pipe = ssl.stdin
...
arCmd = ["C:/Users/etanc/AppData/Local/Arduino15/packages/esp8266/tools/xtensa-lx106-elf-gcc/3.0.4-gcc10.3-1757bed/xtensa-lx106-elf/bin/ar", 'q', 'data/certs.ar'] + derFiles;
call( arCmd )
